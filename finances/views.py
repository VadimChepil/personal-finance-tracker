    ...
    def get_context_data(self, **kwargs):
        ...
        for main_cat in main_categories:
            ...
            categories_hierarchy.append({
                'name': main_cat.name,
                'children': [{'name': child.name, 'id': child.id} for child in children]
            })
        ...
        context['transaction_amounts'] = [
            {
                ...
                'category': {
                    ...
                    'parent_name': transaction.category.parent.name if transaction.category and transaction.category.parent else None
...
def dashboard(request):
    ...
    recent_transactions = Transaction.objects.filter(
        table__user=user
    ).select_related('table', 'category', 'category__parent')[:5]
